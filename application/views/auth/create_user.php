    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <?php echo form_open("?/auth/create_user");?>
                  ...
                  <select id="form-field-2" name="company">
                             <option value=''>Select Drug Code</option>
                             <?php foreach($centers as $center):?>
                                 <option value=<?php echo $center->center_code; ?>><?php echo $center->center_code .": ". $center->center_name; ?></option>
                             <?php endforeach ?>
                         </select>
                  </p>
                  ...
                  <p><?php echo form_submit('submit', lang('create_user_submit_btn'), array('class' => 'col-sm-12 control-label no-padding-right btn btn-primary'));?></p>
